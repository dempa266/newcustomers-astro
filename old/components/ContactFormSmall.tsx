    ...
    <section className="py-10 mb-0">
      <div className="px-6 mx-auto max-w-7xl lg:px-8">
        {submitSuccess ? (
          ...
          >
            <div className="max-w-5xl mx-auto sm:flex space-y-6 sm:space-y-0 sm:space-x-2">
              <input
                type="text"
                name="name"
                id="name"
              ...
              <button
                type="submit"
                className="block w-56 rounded-md bg-primary px-3.5 py-2.5 text-center text-sm text-black shadow-sm hover:bg-primary-dark focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"
              >
                Skicka
              </button>
            </div>
